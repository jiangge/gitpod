...
proto.supervisor.PortsStatusRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    current: jspb.Message.getFieldWithDefault(msg, 1, false)
  };
 ...
 * @return {boolean}
 */
proto.supervisor.PortsStatusRequest.prototype.getCurrent = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 1, false));
};


/** @param {boolean} value */
proto.supervisor.PortsStatusRequest.prototype.setCurrent = function(value) {
  jspb.Message.setProto3BooleanField(this, 1, value);
};
